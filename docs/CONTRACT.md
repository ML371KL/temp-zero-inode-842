...
```json
{
  ...
  "verdict": {
    ...
    "cell_stats": {"mean_fwd1m_pct": -2.94, "hit": 0.54, "n": 25},
  ...
  "core": {
    ...
    "components": [
      {"id": "usd_mom63", "label": "Девальвационный моментум", "z": 1.21,
       "raw": 0.0834, "raw_fmt": "+8.3% за 63д", "tier": "A", "weight": 0.3333,
  ...
  "states": {
    ...
    "distances": [{"id": "bond", "text": "RGBI −4.1% от максимума; флаг снимется при −4.0%",
                   "value": -4.1, "threshold": -4.0, "gap_pct": 0.1}],
